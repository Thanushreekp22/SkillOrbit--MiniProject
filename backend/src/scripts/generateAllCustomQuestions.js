...
const fullStackDeveloperQuestions = [
  // React - Basic
...
console.log("✅ Generated Full Stack Developer questions:", fullStackDeveloperQuestions.length);

// Write to file
const dataDir = path.join(__dirname, '..', 'data');
const filePath = path.join(dataDir, 'fullStackDeveloperQuestions.js');

const fileContent = `// Full Stack Developer Questions - Custom Set
// Skills: React, Node.js, MongoDB, TypeScript, JavaScript
// Total: 75 questions (5 skills × 3 levels × 5 questions each)

export const fullStackDeveloperQuestions = ${JSON.stringify(fullStackDeveloperQuestions, null, 2)};
`;

fs.writeFileSync(filePath, fileContent, 'utf8');
console.log(`✅ File created: ${filePath}`);
console.log("\n🎉 Full Stack Developer questions file generated successfully!");
console.log("📊 Total questions:", fullStackDeveloperQuestions.length);
